...
export const devConfig = {
  ...
  password: '',
  signature:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBfa2V5IjoiZThSeU82RXFSTUdwbW51Q3BNdjhfZyIsInJvbGVfdHlwZSI6MSwidHBjIjoiVGVzdCIsInZlcnNpb24iOjEsImlhdCI6MTcyOTE1OTE4OSwiZXhwIjoxNzI5MTYyNzg5fQ.5bYPkh3T-gW0J1MIcrNxAuRI6gBtda9vrHh_tfWTQy8',
  sessionKey: '',
  userIdentity: '',
