...
export const devConfig = {
  ...
  password: '',
  signature:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBfa2V5IjoiZThSeU82RXFSTUdwbW51Q3BNdjhfZyIsInJvbGVfdHlwZSI6MSwidHBjIjoiVGVzdCIsInZlcnNpb24iOjEsImlhdCI6MTcyOTIzMzU5MSwiZXhwIjoxNzI5MjM3MTkxfQ.eEDtd_TW3AT8RhwHRvDCk0jVkcEU0Rmr5ZpzgswXxYQ',
  sessionKey: '',
  userIdentity: '',
