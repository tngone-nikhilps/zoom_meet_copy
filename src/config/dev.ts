...
export const devConfig = {
  ...
  password: '',
  signature:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBfa2V5IjoiZThSeU82RXFSTUdwbW51Q3BNdjhfZyIsInJvbGVfdHlwZSI6MSwidHBjIjoiVGVzdCIsInZlcnNpb24iOjEsImlhdCI6MTcyOTE3MDM0NywiZXhwIjoxNzI5MTczOTQ3fQ.IQUuQo0p-MxKWJyK2TbcOW1TZk0NpMkP630FWCWldaU',
  sessionKey: '',
  userIdentity: '',
